					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="about-img text-center wow fadeInUp" data-wow-delay="0.6s">
								<img class="img-fluid" src="images/department/1.jpg" alt="about-image">
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Section ID -->	
					 			<span class="section-id blue-color">Welcome to Neuro Hospital - Biratnagar</span>

								<!-- Title -->
								<h3 class="h3-md steelblue-color">Complete Medical Solutions in One Place</h3>

								<!-- Text -->
								<p>Neuro Hospital is a well equipped and state-of-the-art hospital having one of the best standards and quality of care in the management of patients. It comprises of mainly neurological sciences along with other allied sciences.
								</p>
					...
					<div class="row">
						<div class="col-lg-10 offset-lg-1">
							<div class="banner-5-img wow fadeInUp" data-wow-delay="0.4s">
								<img class="img-fluid" src="images/department/team.png" alt="banner-image" />
							</div>
						</div>
					</div>
