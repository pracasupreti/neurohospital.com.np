						...
						<!-- SERVICE DETAILS -->
				 		<div class="col-lg-12">
				 			<div class="txt-block pr-30">
								...
								<!-- Text -->
								<p>Submit your details
								</p>

								<!-- < @pracas use cognito forms > -->
								...
								<div id="appointment-form-holder" class="text-center">
									<form name="appointmentform" class="row appointment-form">
						                ...
						                <!-- <iframe class="airtable-embed" src="https://airtable.com/embed/appQ1irAwnutQPn3X/shr4Vb0oUXUcOA5Me?backgroundColor=blue" frameborder="0" onmousewheel="" width="100%" height="1933" style="background: transparent; border: 1px solid #ccc;"></iframe> -->
								...
								<!-- Text -->
								<p class="p-sm grey-color mb-30">* We keep your data safe.
								</p>
